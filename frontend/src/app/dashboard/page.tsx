      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3">
        ...
        <div className="lg:col-span-4 lg:border-l-1 border-black lg:pl-3 mt-4 lg:mt-0 pt-4 lg:pt-0 border-t-1 lg:border-t-0">
          ...
          <div className="mt-4 border-t-1 border-hairline-tint pt-4">
            <div className="font-mono text-sm uppercase text-caption-gray mb-1">Featured Profile</div>
            <div className="aspect-[4/3] border-2 border-black overflow-hidden mb-1 bg-[#e2e2e2]">
              <img alt="Team meeting" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-300" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD1B7NAbz6GoSomBrt0L4fy66z_yAmRkQUQ8p2BXj8PZLcsffGm7rL2P-Bko032Gc2I9rV-LAj3y9qUipaCos8PcoOXy0Uxhtyk10qKMfP__lB5S2sAjAMM2RIXgI5IPXc-oczziSTRo5fRXtJKSKLMZWTl-UI-RLLprpVQ3nBfHWydZuS3PqbJXTU7fs8UstwwMNPg75qAZUQb8JxzDZNG4_iJWyIXjoHhZoTDD9aGibjS9e-7eT3kbE6cV10-fp-tsyhqhlxhZC9N" />
            </div>
            <h4 className="font-ui text-xl font-bold mb-0.5">The Planning Committee at Work</h4>
            <p className="font-body text-base text-[#4c4546]">Preparations for the winter summit are underway in the west wing strategy room.</p>
          </div>
        </div>
      </div>
    </div>
